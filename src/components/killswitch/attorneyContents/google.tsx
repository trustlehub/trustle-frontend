  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <h1 className="font-secondary text-sm text-grey-700">
        ...
        my Google account ("Google Account") (hereinafter referred to as "the
        ...
        initiate and facilitate the removal of my Google account. I authorise
        Trustle, through its KillSwitch service, to carry out the following
        procedure for the removal of the Account:
        <br />
        <br />
        Access: My Attorney-in-Fact is authorised to access the Google account
        ...
        <br />
        <br />
        I affirm that I am the legal owner of the Google account identified
        ...
        may arise from the removal of my Google account, including the loss of
