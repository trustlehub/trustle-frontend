  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <h1 className="font-secondary text-sm text-grey-700">
        ...
        my Telegram account ("Telegram Account") (hereinafter referred to as
        ...
        removal of my Telegram account. I authorise Trustle, through its
        KillSwitch service, to carry out the following procedure for the removal
        of the Account:
        <br />
        <br />
        Access: My Attorney-in-Fact is authorised to access the Telegram account
        associated with the following URL: {url}.
        <br />
        <br />
        Removal Request: My Attorney-in-Fact shall use the KillSwitch service to
        send a removal request to Telegram, requesting the permanent deletion of
        the Account.
        <br />
        <br />
        Communication: My Attorney-in-Fact is authorised to communicate with
        Telegram, as necessary, to facilitate the removal process. This includes
        ...
        verification or identification information to Telegram, to confirm my
        identity as the account holder, as required by Telegram, for account
        removal.
        <br />
        <br />
        ...
        confirmation messages or notifications received from Telegram.
        <br />
        <br />
        ...
        shall act in accordance with Telegram's policies and procedures
        governing account removal.
        <br />
        <br />
        I affirm that I am the legal owner of the Telegram account identified
        ...
        may arise from the removal of my Telegram account, including the loss of
