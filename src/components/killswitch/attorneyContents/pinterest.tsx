  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <h1 className="font-secondary text-sm text-grey-700">
        ...
        my Pinterest account ("Pinterest Account") (hereinafter referred to as
        "the Account"), including any associated content and data. I understand
        and agree that this power of attorney is being granted for the purpose
        of utilising Trustle's KillSwitch service to initiate and facilitate the
        removal of my Pinterest account. I authorise Trustle, through its
        KillSwitch service, to carry out the following procedure for the removal
        of the Account:
        <br />
        <br />
        Access: My Attorney-in-Fact is authorised to access the Pinterest
        account associated with the following URL: {url}.
        <br />
        <br />
        Removal Request: My Attorney-in-Fact shall use the KillSwitch service to
        send a removal request to Pinterest, requesting the permanent deletion
        of the Account.
        <br />
        <br />
        Communication: My Attorney-in-Fact is authorised to communicate with
        Pinterest, as necessary, to facilitate the removal process. This
        includes but is not limited to responding to any verification or
        confirmation requests from Pinterest.
        <br />
        <br />
        Verification: My Attorney-in-Fact is authorised to provide any necessary
        verification or identification information to Pinterest to confirm my
        identity as the account holder, as required by Pinterest for account
        removal.
        <br />
        <br />
        ...
        confirmation messages or notifications received from Pinterest.
        <br />
        <br />
        ...
        shall act in accordance with Pinterest’s policies and procedures
        governing account removal.
        <br />
        <br />
        I affirm that I am the legal owner of the Pinterest account identified
        ...
        may arise from the removal of my Pinterest account, including the loss
