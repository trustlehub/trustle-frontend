  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <h1 className="font-secondary text-sm text-grey-700">
        ...
        my TikTok account ("TikTok Account") (hereinafter referred to as "the
        ...
        removal of my TikTok account. I authorise Trustle, through its
        KillSwitch service, to carry out the following procedure for the removal
        of the Account:
        <br />
        <br />
        Access: My Attorney-in-Fact is authorised to access the TikTok account
        associated with the following URL: {url}.
        <br />
        <br />
        Removal Request: My Attorney-in-Fact shall use the KillSwitch service to
        send a removal request to TikTok, requesting the permanent deletion of
        the Account.
        <br />
        <br />
        Communication: My Attorney-in-Fact is authorised to communicate with
        TikTok, as necessary, to facilitate the removal process. This includes
        but is not limited to responding to any verification or confirmation
        requests from TikTok.
        <br />
        <br />
        Verification: My Attorney-in-Fact is authorised to provide any necessary
        verification or identification information to TikTok, to confirm my
        identity as the account holder, as required by TikTok, for account
        removal.
        <br />
        <br />
        ...
        confirmation messages or notifications received from TikTok.
        <br />
        <br />
        ...
        shall act in accordance with TikTok's policies and procedures governing
        account removal.
        <br />
        <br />
        I affirm that I am the legal owner of the TikTok account identified
        ...
        may arise from the removal of my TikTok account, including the loss of
