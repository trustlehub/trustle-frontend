  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <h1 className="font-secondary text-sm text-grey-700">
        ...
        my GitHub account ("GitHub Account") (hereinafter referred to as "the
        Account") owned by GitHub, Inc., including any associated content and
        ...
        initiate and facilitate the removal of my GitHub account. I authorise
        Trustle, through its KillSwitch service, to carry out the following
        procedure for the removal of the Account:
        <br />
        <br />
        Access: My Attorney-in-Fact is authorised to access the GitHub account
        associated with the following URL: {url}.
        <br />
        <br />
        Removal Request: My Attorney-in-Fact shall use the KillSwitch service to
        send a removal request to GitHub, Inc., requesting the permanent
        deletion of the Account.
        <br />
        <br />
        Communication: My Attorney-in-Fact is authorised to communicate with
        GitHub, Inc., as necessary, to facilitate the removal process. This
        includes but is not limited to responding to any verification or
        confirmation requests from GitHub, Inc.
        <br />
        <br />
        Verification: My Attorney-in-Fact is authorised to provide any necessary
        verification or identification information to GitHub, Inc. to confirm my
        identity as the account holder, as required by GitHub, Inc., for account
        removal.
        <br />
        <br />
        ...
        confirmation messages or notifications received from GitHub, Inc.
        <br />
        <br />
        ...
        shall act in accordance with GitHub, Inc’s policies and procedures
        governing account removal.
        <br />
        <br />
        I affirm that I am the legal owner of the GitHub account identified
        ...
        may arise from the removal of my GitHub account, including the loss of
