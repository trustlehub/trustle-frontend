  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <h1 className="font-secondary text-sm text-grey-700">
        ...
        my Facebook account ("Facebook Account") (hereinafter referred to as
        ...
        to initiate and facilitate the removal of my Facebook account. I
        authorise Trustle, through its KillSwitch service, to carry out the
        following procedure for the removal of the Account:
        <br />
        <br />
        Access: My Attorney-in-Fact is authorised to access the Facebook account
        ...
        <br />
        <br />
        I affirm that I am the legal owner of the Facebook account identified
        ...
        may arise from the removal of my Facebook account, including the loss of
