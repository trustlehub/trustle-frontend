  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <h1 className="font-secondary text-sm text-grey-700">
        ...
        my OnlyFans account ("OnlyFans Account") (hereinafter referred to as
        ...
        removal of my OnlyFans account. I authorise Trustle, through its
        KillSwitch service, to carry out the following procedure for the removal
        of the Account:
        <br />
        <br />
        Access: My Attorney-in-Fact is authorised to access the OnlyFans account
        associated with the following URL: {url}.
        <br />
        <br />
        Removal Request: My Attorney-in-Fact shall use the KillSwitch service to
        send a removal request to OnlyFans, requesting the permanent deletion of
        the Account.
        <br />
        <br />
        Communication: My Attorney-in-Fact is authorised to communicate with
        OnlyFans, as necessary, to facilitate the removal process. This includes
        but is not limited to responding to any verification or confirmation
        requests from OnlyFans.
        <br />
        <br />
        Verification: My Attorney-in-Fact is authorised to provide any necessary
        verification or identification information to OnlyFans, to confirm my
        identity as the account holder, as required by OnlyFans, for account
        removal.
        <br />
        <br />
        ...
        confirmation messages or notifications received from OnlyFans.
        <br />
        <br />
        ...
        shall act in accordance with OnlyFans's policies and procedures
        governing account removal.
        <br />
        <br />
        I affirm that I am the legal owner of the OnlyFans account identified
        ...
        may arise from the removal of my OnlyFans account, including the loss of
