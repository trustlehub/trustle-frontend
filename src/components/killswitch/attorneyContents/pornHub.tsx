  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <h1 className="font-secondary text-sm text-grey-700">
        ...
        my PornHub account ("PornHub Account") (hereinafter referred to as "the
        Account"), including any associated content and data. I understand and
        agree that this power of attorney is being granted for the purpose of
        utilising Trustle's KillSwitch service to initiate and facilitate the
        removal of my PornHub account. I authorise Trustle, through its
        KillSwitch service, to carry out the following procedure for the removal
        of the Account:
        <br />
        <br />
        Access: My Attorney-in-Fact is authorised to access the PornHub account
        associated with the following URL: {url}.
        <br />
        <br />
        Removal Request: My Attorney-in-Fact shall use the KillSwitch service to
        send a removal request to PornHub, requesting the permanent deletion of
        the Account.
        <br />
        <br />
        Communication: My Attorney-in-Fact is authorised to communicate with
        PornHub, as necessary, to facilitate the removal process. This includes
        but is not limited to responding to any verification or confirmation
        requests from PornHub.
        <br />
        <br />
        Verification: My Attorney-in-Fact is authorised to provide any necessary
        verification or identification information to PornHub, to confirm my
        identity as the account holder, as required by PornHub, for account
        removal.
        <br />
        <br />
        ...
        confirmation messages or notifications received from PornHub.
        <br />
        <br />
        ...
        shall act in accordance with PornHub's policies and procedures governing
        account removal.
        <br />
        <br />
        I affirm that I am the legal owner of the PornHub account identified
        ...
        may arise from the removal of my PornHub account, including the loss of
